...
function blockModel(username) {
  return window.ArchivebateBlockedModels.block(username);
}

function unblockModel(username) {
  return window.ArchivebateBlockedModels.unblock(username);
}

function updateBlockedModelsCount() {
  return window.ArchivebateBlockedModels.updateCount();
}

function showBlockedModelsManager() {
  return window.ArchivebateBlockedModels.showManager();
}
